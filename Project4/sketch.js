...
let spriteSheetFilenames = ["butterflySpriteFull.png"];
let spriteSheets = [];
let totalAnimations = 11;
let animations = [];
...
function setup() {
  ...
  for(let i=0; i < totalAnimations; i++) {
    animations[i] = new WalkingAnimation(random(spriteSheets),32,32,random(100,300),random(100,300),10,random(0.5,1),6);
  }
}
